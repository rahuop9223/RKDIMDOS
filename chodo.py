...
bot = telebot.TeleBot('8377162532:AAEEd79vy3XioYfAsHQ76ncgjnDSpnG9ZRQ')
...
#  Join Official Channel @RAHUMODZOWNER
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @RAHUMODZOWNER."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @RAHUMODZOWNER ."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 180:
                response = "Error: Buy From @RAHUMODZOWNER For More Time"
            else:
...
Buy From :- @RAHUMODZOWNER
Official Channel :- https://t.me/rahumod
'''
...
3. MAKE SURE YOU JOINED https://t.me/rahumod OTHERWISE NOT WORK
